...
- **Chapter 18** — what is needed to scale a proof of concept to a real world model.
- **Chapter 19** — Chollet's argument for what deep learning is and isn't
...
| Tuner | Idea |
|:--|:--|
| `GridSearch` | Systematic search |
| `RandomSearch` |  Like it sounds... |
...
- Example: 2014 Higgs Boson challenge 4th place entry combined tree models and deep nets.
...
- "prompt engineering": minor changes and tank performanece!
