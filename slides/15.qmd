...
**Encoder** reads entire source; **decoder** generates from `[start]` to `[end]`
...
- Answer: Attention is all you need! (https://arxiv.org/abs/1706.03762 - Vaswani et. al.)
...
:::: notes
Causal mask has the same motivation as not using a bidirectional RNN language model - discuss?
::::
