...
format:
  revealjs:
    footer: '<a href="/" target="deeppy_club-index">DSLC.io/deeppy</a> | <a href="https://DSLC.io" target="_blank">DSLC.io</a> | Images: <a href="https://deeplearningwithpython.io" target="_blank">deeplearningwithpython.io</a>'
---
...
- ML works by finding meaningful **representations** of the data

- Representations are transformations/encodings of data that makes a task easier.
...
- Fluent chatbots & programming assistants (Copilot, Claude code)
...
- Openai alone 20B revenue in 2025
- Investment  >> Revenue >> Profits
...
> "AI is like a cartoon character, while intelligence is like a living being.  A cartoon, no matter how realistic, can only act out the scenes it was drawn for"
...
From previous edition of this book book (written in 2017):
...
- ChatGPT/Claude agents help write code (and homeowrk!)
- Waymo's a common site in my city (Phoenix)
- AlphaFold transforming biology
- Terence Tao: AI as "reliable co-author" in mathematics by ~2026
