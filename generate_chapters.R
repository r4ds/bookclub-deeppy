...
chapter_contents <- dplyr::filter(toc, .data$number_wide %in% names(slide_files)) |> 
...
quarto_index$website$sidebar$contents <- c(standard_parts, chapter_contents)
